...
1. #### Create a new RDS instance
    ...
    - For the database creation method select "Standard Create", for engine type select "PostgreSQL" (v12.9-R1 for consistency with our Docker Image), and for Templates select "Free Tier". 
